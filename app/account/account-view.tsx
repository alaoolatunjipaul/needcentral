...
export function AccountView({
  ...
  sessionUser: AccountSession | null;
}) {
      ...
      <div className="grid gap-6 pb-16 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          ...
          <p className="mt-5 text-xs leading-5 text-zinc-400">
            This is a simulated marketplace experience. Orders and saved items
            are stored locally in your browser&apos;s localStorage, while
            authentication uses a real server-side session.
          </p>
        </section>
      </div>
    </div>
